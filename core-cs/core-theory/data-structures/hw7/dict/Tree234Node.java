...
class Tree234Node {
   ...
   * 
   * key1 through key3 are the keys of this node.
   * 
   * If keys == 1, the value of key2 doesn't matter.
   * 
   * If keys < 3, the value of key3 doesn't matter.
   * 
   * parent is this node's parent; null if this is the root.
   * 
   * child1 through child4 are the children of this node.
   * 
   * If this is a leaf node, they must all be set to null.
   * 
   * If this node has no third and/or fourth child, child3 and/or child4 must be
   * set to null.
   **/
  int keys;
  int key1;
  ...
  /**
   * printSubtree() recursively prints this Tree234Node and its descendants as a
   * tree (albeit sideways).
   *
