...
/**
 * A TreeNode object is a mutable node in a tree. No implementation is provided.
 *
...
public abstract class TreeNode {
  ...
  /**
   * item references the item stored in this node. valid is true if and only if
   * this is a valid node in some Tree.
   *
