...
class SListNode {
  ...
  /**
   * SListNode() (with one parameter) constructs a list node referencing the item
   * "obj".
   */
  ...
  /**
   * SListNode() (with two parameters) constructs a list node referencing the item
   * "obj", whose next list node is to be "next".
   */
