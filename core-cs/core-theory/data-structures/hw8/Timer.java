...
public class Timer {
  ...
  /**
   * Stops the timer. returns the time elapsed since the last matching call to
   * start(), or zero if no such matching call was made.
   **/
  public long stop() {
  ...
  /**
   * if RUNNING() ==> returns the time since last call to start() if !RUNNING()
