...
public class DList {
   ...
   */
  /*
   * public DListNode next(DListNode node) { // Your solution here. }
   */
   ...
   */
  /*
   * public DListNode prev(DListNode node) { // Your solution here. }
   */
  ...
  public static void main(String[] args) {
    ...
    /*
     * testEmpty(); testAfterInsertFront(); testAfterInsertEnd();
     */
