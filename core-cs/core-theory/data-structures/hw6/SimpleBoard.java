...
public class SimpleBoard {
   ...
   * grid[i].length == DIMENSION. (3) for all 0 <= i, j < DIMENSION, grid[i][j] >=
   * 0 and grid[i][j] <= 2.
   **/
   ...
   * @exception ArrayIndexOutOfBoundsException is thrown if an invalid index is
   *                                           given.
   **/
  ...
  /**
   * Returns true if "this" SimpleBoard and "board" have identical values in every
   * cell.
   * 
