...
public class Test {
   ...
   * Does it make a difference if the array of type X[] references objects that
   * are all of class Y ?
   * answer:
   ...
   * and implements a java interface that contains a "public static final"
   * constant
   * with the same name
   * a)No it wont it doesnt matter, in the interface you don't usually assign
   * values
