...
public class ListEnum implements Enumeration {
  ...
  /**
   * Creates a new enumeration for the elements linked with ListNodes starting
   * with l. Requires that there are no cycles in the list.
   */
  ...
  /**
   * Returns the next element of this enumeration. Modifies the enumeration to
   * move the enumeration past the returned element of the list.
   * 
