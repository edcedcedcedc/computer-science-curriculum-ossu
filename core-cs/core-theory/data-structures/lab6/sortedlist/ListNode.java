...
/**
 * ListNode is a class used internally by the List class. Each node in a List is
 * represented as a ListNode, with an item and a reference to the next node in
 * the list.
 **/
class ListNode {
  Keyable item;
  ...
  /**
   * ptrTo() returns a reference to the node at the given position. If position <
   * 1 or position > the number of nodes in the list, returns null. Assumes the
   * list is acyclic.
   * 
