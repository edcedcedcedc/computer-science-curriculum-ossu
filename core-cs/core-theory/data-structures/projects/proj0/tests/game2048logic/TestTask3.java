...
public class TestTask3 {
         ...
         *
         * Note that this isn't a comprehensive test for empty space. For that, see the
         * TestTask1 class.
         */
        @Test
        @Tag("task3")
        ...
        public void testEmptySpace() {
                int[][] rawVals = new int[][] { { 0, 0, 4, 0 }, { 0, 0, 0, 0 }, { 0, 2, 0, 0 }, { 0, 0, 0, 0 }, };
        ...
        public void testAnyDir() {
                int[][] rawVals = new int[][] { { 2, 4, 2, 2 }, { 4, 2, 4, 2 }, { 2, 4, 2, 4 }, { 4, 2, 4, 2 }, };

                Model m = new Model(rawVals, 0);
                assertWithMessage("A tilt in any direction will change the board\n" + m.getBoard())
                                .that(m.atLeastOneMoveExists()).isTrue();
        }
        ...
        public void testLeftOrRight() {
                int[][] rawVals = new int[][] { { 2, 4, 2, 4 }, { 4, 8, 4, 2 }, { 2, 2, 2, 4 }, { 4, 8, 4, 2 }, };
        ...
        public void testUpOrDown() {
                int[][] rawVals = new int[][] { { 2, 4, 2, 4 }, { 4, 8, 4, 2 }, { 2, 16, 4, 8 }, { 4, 8, 4, 2 }, };
         ...
         *
         * While having the max tile on the board does mean the game is over, it should
        ...
        public void testMoveExistsMaxPiece() {
                int[][] rawVals = new int[][] { { 2, 4, 2, 4 }, { 4, 2, 4, 2 }, { 2, 2, 2, 4 }, { 4, 2, 4, 2048 }, };
        ...
        public void testNoMoveExists2() {
                int[][] rawVals = new int[][] { { 2, 1024, 2, 4 }, { 4, 2, 4, 2 }, { 2, 8, 16, 4 }, { 512, 2, 4, 2 }, };
        ...
        public void testNoMoveExists3() {
                int[][] rawVals = new int[][] { { 8, 4, 2, 32 }, { 32, 2, 4, 2 }, { 2, 8, 2, 4 }, { 4, 64, 4, 64 }, };
        ...
        public void testNoMoveExists4() {
                int[][] rawVals = new int[][] { { 2, 4, 2, 32 }, { 32, 2, 4, 2 }, { 2, 128, 2, 4 }, { 4, 2, 4, 2 }, };
        ...
        public void testNoMoveExists5() {
                int[][] rawVals = new int[][] { { 8, 16, 2, 32 }, { 32, 2, 64, 2 }, { 2, 256, 128, 256 },
                                { 1024, 8, 4, 2 }, };
        ...
        public void testMoveExistsCorner1() {
                int[][] rawVals = new int[][] { { 8, 16, 4, 2 }, { 32, 2, 64, 2 }, { 2, 256, 128, 256 },
                                { 1024, 8, 4, 2 }, };
        ...
        public void testMoveExistsCorner2() {
                int[][] rawVals = new int[][] { { 8, 16, 2, 2 }, { 32, 2, 64, 4 }, { 2, 256, 128, 256 },
                                { 1024, 8, 4, 2 }, };
        ...
        public void testMoveExistsCorner3() {
                int[][] rawVals = new int[][] { { 8, 8, 32, 2 }, { 32, 2, 64, 4 }, { 2, 256, 128, 256 },
                                { 1024, 8, 4, 2 }, };
        ...
        public void testMoveExistsCorner4() {
                int[][] rawVals = new int[][] { { 8, 16, 32, 2 }, { 8, 2, 64, 4 }, { 2, 256, 128, 256 },
                                { 1024, 8, 4, 2 }, };
        ...
        public void testMoveExistsCorner5() {
                int[][] rawVals = new int[][] { { 8, 16, 32, 2 }, { 32, 2, 64, 4 }, { 1024, 256, 128, 256 },
                                { 1024, 8, 4, 2 }, };
        ...
        public void testMoveExistsCorner7() {
                int[][] rawVals = new int[][] { { 8, 16, 32, 2 }, { 8, 2, 64, 4 }, { 2, 256, 128, 2 },
                                { 1024, 32, 4, 2 }, };
