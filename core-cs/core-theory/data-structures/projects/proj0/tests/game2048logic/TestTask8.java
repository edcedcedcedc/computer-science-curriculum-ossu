...
public class TestTask8 {
        ...
        /**
         * Move tiles up with a merge. Must merge in the proper order. Score does not
         * matter.
         */
        @Test
        @Tag("task8")
        ...
        public void testUpMergeNoSkips() {
                int[][] board = new int[][] { { 4, 4, 4, 4 }, { 2, 2, 2, 2 }, { 2, 2, 2, 2 }, { 4, 4, 4, 4 }, };

                Model before = new Model(board, 0);
                before.tiltWrapper(Side.NORTH);

                int[][] result = new int[][] { { 4, 4, 4, 4 }, { 4, 4, 4, 4 }, { 4, 4, 4, 4 }, { 0, 0, 0, 0 }, };
        ...
        public void testUpComplicated() {
                int[][] board = new int[][] { { 4, 4, 4, 0 }, { 0, 4, 8, 2 }, { 2, 4, 2, 2 }, { 4, 4, 2, 0 }, };

                Model before = new Model(board, 0);
                before.tiltWrapper(Side.NORTH);

                int[][] result = new int[][] { { 4, 8, 4, 4 }, { 2, 8, 8, 0 }, { 4, 0, 4, 0 }, { 0, 0, 0, 0 }, };
