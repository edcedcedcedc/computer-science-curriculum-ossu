...
public class RunLengthEncoding implements Iterable {
       ...
       /**
        * Define any variables associated with a RunLengthEncoding object here. These
       ...
       /**
        * RunLengthEncoding() (with two parameters) constructs a run-length encoding of
        * a black PixImage of the specified width and height, in which every pixel has
        * red, green, and blue intensities of zero.
        *
       ...
       /**
        * RunLengthEncoding() (with six parameters) constructs a run-length encoding of
        * a PixImage of the specified width and height. The runs of the run-length
        * encoding are taken from four input arrays of equal length. Run i has length
        * runLengths[i] and RGB intensities red[i], green[i], and blue[i].
        *
        * @param width      the width of the image.
        * @param height     the height of the image.
        ...
        *
        *                   NOTE: All four input arrays should have the same length
        *                   (not zero). All pixel intensities in the first three arrays
        *                   should be in the range 0...255. The sum of all the elements
        *                   of the runLengths array should be width * height. (Feel
        *                   free to quit with an error message if any of these
       ...
       /**
        * iterator() returns a newly created RunIterator that can iterate through the
        * runs of this RunLengthEncoding.
        *
        ...
        * debugging your code. It's up to you how you represent a RunLengthEncoding as
        * a String.
        *
       ...
       /**
        * check() walks through the run-length encoding and prints an error message if
        * two consecutive runs have the same RGB intensities, or if the sum of all run
        * lengths does not equal the number of pixels in the image.
        */
       public void check() {
              // Your solution here.
       }
       ...
       /**
        * setPixel() modifies this run-length encoding so that the specified color is
        * stored at the given (x, y) coordinates. The old pixel value at that
        * coordinate should be overwritten and all others should remain the same. The
        * updated run-length encoding should be compressed as much as possible; there
        * should not be two consecutive runs with exactly the same RGB color.
        *
       ...
       /**
        * setAndCheckRLE() sets the given coordinate in the given run-length encoding
