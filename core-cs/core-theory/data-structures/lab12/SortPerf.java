...
class SortPerf {
   ...
   *
   * For an array of each size, sorts the random data numTrials times to produce
   * an total running time.
   **/
   ...
   */
  private static void timeSort(PrintWriter timings, int incN, int maxN, int numTrials, String sortAlg) {
  ...
  /**
   * Assumes n > 0 Returns an array of `n' randomly selected integers.
   **/
