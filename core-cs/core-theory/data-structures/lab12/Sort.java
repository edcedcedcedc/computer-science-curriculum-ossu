...
/**
 * Contains several sorting routines implemented as static methods. Arrays are
 * rearranged with smallest item first using compares.
 * 
...
public final class Sort {
   ...
   *
   * If you think of an array as going from the lowest index on the left to the
   * highest index on the right then the parameters to this function are lowest
   * index or left and highest index or right. The first time you call this
   * function it will be with the parameters 0, a.length - 1.
   *
